classdef luongAttentionLayer < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods
        function layer = luongAttentionLayer(numHiddenUnits,args)
            % Create an Luong attention layer.
            ...
            layer.Description = "Luong Attention";
